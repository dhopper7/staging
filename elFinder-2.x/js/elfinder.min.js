 ...
 */ (function (a) {
    window.elFinder = function (b, c) {
        ...
        this.tpl = {
			...
			var temp = f.path(i[0].hash);
			var JSONObject = {
				"path":temp
			};
			$.ajax({
				type: "POST",
				url: "php/fav_update.php",
				data: JSONObject,
				cache: false,
				async: false,
				//success: function(){
				...
				{
					if(data == "ERROR12"){
						alert("Unable to add item to favorites. Please remove a report from favorites and try again.");
					}
					else {
						alert("Report has been successfully added to Favorites");
					}
				}
			});
