...
function tpear()
{
include_once('../../../../jqSuitePHP_Sources_4_4_4_0/php/adodb5/tests/DB.php');
...
?>
<a href=../../../../jqSuitePHP_Sources_4_4_4_0/php/adodb5/tests/tmssql.php?do=tmssql>mssql</a>
<a href=../../../../jqSuitePHP_Sources_4_4_4_0/php/adodb5/tests/tmssql.php?do=tpear>pear</a>
<a href=../../../../jqSuitePHP_Sources_4_4_4_0/php/adodb5/tests/tmssql.php?do=tadodb>adodb</a>
<?php
if (!empty($_GET['do'])) {
	$do = $_GET['do'];
	switch($do) {
