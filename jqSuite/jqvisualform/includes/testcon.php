 ...
 */
include_once '../../../jqSuitePHP_Sources_4_4_4_0/jqvisualform/includes/connections.php';
include_once '../../../jqSuitePHP_Sources_4_4_4_0/jqvisualform/php/jqUtils.php';
...
if($action == 'genform') {
	if($dbtype == 'mysql' || $dbtype=='pgsql' || $dbtype=='sqlite')
	{
		include '../../../jqSuitePHP_Sources_4_4_4_0/jqvisualform/php/jqGridPdo.php';
