...
<form id="input_text">
	<table style="table-layout: auto;width:600px;">
		...
		<tr class="otherparam">
			...
			<td>
				<input type="checkbox" id="checked" name="checked" class="ui-widget-content ui-corner-all input-ui"/>
			</td>
			<td class="help" title="<?php echo $checked?>"><span class='ui-icon ui-icon-info'></span></td>
		</tr>
		<tr class="otherparam">
			<td>
			...
			<td>
				<input type="text" id="value" style="width:98%;" name="value" class="ui-widget-content ui-corner-all input-ui" value="on"/>
			</td>
			<td class="help" title="<?php echo $value?>"><span class='ui-icon ui-icon-info'></span></td>
		</tr>
		<tr class="otherparam">
			<td>
				<label for="offval"> Off Value </label>
			</td>
			<td>
				<input type="text" id="offval" style="width:98%;" name="offval" class="ui-widget-content ui-corner-all input-ui" value="off"/>
			</td>
			<td class="help" title="<?php echo $offval?>"><span class='ui-icon ui-icon-info'></span></td>
		</tr>
		<tr class="otherparam">
			<td>
