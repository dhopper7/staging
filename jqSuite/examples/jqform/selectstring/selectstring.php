<?php
// Include class 
include_once '../../../../jqSuitePHP_Sources_4_4_4_0/examples/jqform/selectstring/jqformconfig.php'; 
...
// Set url
$newForm->setUrl($SERVER_HOST.$SELF_PATH.'selectstring.php');
// Set Form header 
...
$newForm->addElement('ShipCountry','select', array('label' => 'Country', 'datalist' => 'Argentina:Argentina;Belgium:Belgium;Bulgaria:Bulgaria', 'id' => 'newForm_ShipCountry'));
