<?php
// Include class 
include_once '../../../../jqSuitePHP_Sources_4_4_4_0/examples/jqform/selectdb/jqformconfig.php'; 
...
// Set url
$newForm->setUrl($SERVER_HOST.$SELF_PATH.'selectdb.php');
// Set Form header 
...
$newForm->addElement('ShipCountry','select', array('label' => 'Country', 'datasql' => 'SELECT ShipCountry FROM orders  WHERE ShipCountry <> "" GROUP BY ShipCountry', 'id' => 'newForm_ShipCountry'));
