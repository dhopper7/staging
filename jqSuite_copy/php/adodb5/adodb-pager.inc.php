...
class ADODB_Pager {
	...
	global $PHP_SELF;
		if ($anchor) {
	?>
		<a href="<?php echo $PHP_SELF,'../../../jqSuite/php/adodb5/?',$this->id;?>_next_page=1"><?php echo $this->first;?></a> &nbsp; 
	<?php
		} else {
			print "$this->first &nbsp; ";
		}
	...
	global $PHP_SELF;
		...
		if ($anchor) {
		?>
		<a href="<?php echo $PHP_SELF,'../../../jqSuite/php/adodb5/?',$this->id,'_next_page=',$this->rs->AbsolutePage() + 1 ?>"><?php echo $this->next;?></a> &nbsp; 
		<?php
		} else {
			print "$this->next &nbsp; ";
		}
	...
	global $PHP_SELF;
		...
		if ($anchor) {
		?>
			<a href="<?php echo $PHP_SELF,'../../../jqSuite/php/adodb5/?',$this->id,'_next_page=',$this->rs->LastPageNo() ?>"><?php echo $this->last;?></a> &nbsp; 
		<?php
		} else {
			print "$this->last &nbsp; ";
		}
	...
	global $PHP_SELF;
		if ($anchor) {
	?>
		<a href="<?php echo $PHP_SELF,'../../../jqSuite/php/adodb5/?',$this->id,'_next_page=',$this->rs->AbsolutePage() - 1 ?>"><?php echo $this->prev;?></a> &nbsp; 
	<?php 
		} else {
			print "$this->prev &nbsp; ";
		}
