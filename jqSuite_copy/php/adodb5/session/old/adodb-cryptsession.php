...
wrapper library.
 ...
 =======
	...
	include('../../../../../jqSuite/php/adodb5/session/old/adodb.inc.php');
	#---------------------------------#
	include('../../../../../jqSuite/php/adodb5/session/old/adodb-cryptsession.php'); 
	#---------------------------------#
	session_start();
...
include_once('../../../../../jqSuite/php/adodb5/session/old/crypt.inc.php');
