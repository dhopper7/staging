...
if (PHP_VERSION < 5) include_once('../../../../jqSuite/php/adodb5/adodb-pear.inc.php');
//--------------------------------------------------------------------------------------
...
global $ADODB_EXTENSION;
	...
	include_once('../../../../jqSuite/php/adodb5/session/adodb-session.php');
...
//	$db->Execute('select * from table where val=? AND value=?', array('val'=>'http ://www.whatever.com/test?=21', 'value'=>'blabl'));
 ...
 //	$db->debug=true;
	...
	print "<p>Test CSV</p>";
	include_once('../../../../jqSuite/php/adodb5/toexport.inc.php');
	//$ADODB_FETCH_MODE = ADODB_FETCH_ASSOC;
	...
	/////////////////////////////////////////////////////////////
	include_once('../../../../jqSuite/php/adodb5/pivottable.inc.php');
	...
	include_once "../../../../jqSuite/php/adodb5/tests/PEAR.php";
...
include("../../../../jqSuite/php/adodb5/tohtml.inc.php");
include("../../../../jqSuite/php/adodb5/adodb.inc.php");
include("../../../../jqSuite/php/adodb5/rsfilter.inc.php");
...
Test <a href=../../../../jqSuite/php/adodb5/tests/test4.php>GetInsertSQL/GetUpdateSQL</a> &nbsp; 
	<a href=../../../../jqSuite/php/adodb5/tests/testsessions.php>Sessions</a> &nbsp;
	<a href=../../../../jqSuite/php/adodb5/tests/testpaging.php>Paging</a> &nbsp;
	<a href=../../../../jqSuite/php/adodb5/tests/test-perf.php>Perf Monitor</a><p>
<?php


include_once('../../../../jqSuite/php/adodb5/adodb-time.inc.php');
if (isset($_GET['time'])) adodb_date_test();
flush();

include_once('../../../../jqSuite/php/adodb5/tests/testdatabases.inc.php');
