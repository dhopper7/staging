...
include("../../../../jqSuite/php/adodb5/tests/adodb-exceptions.inc.php");
include("../../../../jqSuite/php/adodb5/tests/adodb.inc.php");	
...
echo "<h3>Active Record</h3>";
	...
	include_once("../../../../jqSuite/php/adodb5/adodb-active-record.inc.php");
...
//include_once("../../../../jqSuite/php/adodb5/tests/test-active-record.php");
?>