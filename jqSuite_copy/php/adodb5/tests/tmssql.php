...
function tpear()
{
include_once('../../../../jqSuite/php/adodb5/tests/DB.php');
...
function tadodb()
{
include_once('../../../../jqSuite/php/adodb5/adodb.inc.php');
...
?>
<a href=../../../../jqSuite/php/adodb5/tests/tmssql.php?do=tmssql>mssql</a>
<a href=../../../../jqSuite/php/adodb5/tests/tmssql.php?do=tpear>pear</a>
<a href=../../../../jqSuite/php/adodb5/tests/tmssql.php?do=tadodb>adodb</a>
<?php
if (!empty($_GET['do'])) {
	$do = $_GET['do'];
	switch($do) {
