...
<form id="input_text">
	<table style="table-layout: auto;width:600px;">
		...
		<tr class="otherparam">
			...
			<td>
				<input type="text" id="text" style="width:98%;" name="text" class="ui-widget-content ui-corner-all input-ui"/>
			</td>
			<td class="help" title="<?php echo $text?>"><span class='ui-icon ui-icon-info'></span></td>
		</tr>
		<tr>
			<td colspan="3" style="">
				<div class="ui-state-default ui-corner-all" style="padding:6px;">
