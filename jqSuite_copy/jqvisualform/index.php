<!DOCTYPE html>
<?php
include_once("../../jqSuite/jqvisualform/lang/info_en_GB.inc");
try {
	include_once '../../jqSuite/jqvisualform/form_conf.inc.php';
} catch (Exception $e) {
	$demo = false;
	$projectdir = "";
}
...
<link rel="stylesheet" type="text/css" media="screen" href="../../jqSuite/jqvisualform/themes/redmond/jquery-ui-custom.css"/>
<link rel="stylesheet" type="text/css" media="screen" href="../../jqSuite/jqvisualform/themes/ui.jqgrid.css"/>
<link rel="stylesheet" type="text/css" media="screen" href="../../jqSuite/jqvisualform/themes/jqueryFileTree.css"/>
<link rel="stylesheet" type="text/css" media="screen" href="../../jqSuite/jqvisualform/js/codemirror/lib/codemirror.css">
...
<script type="text/javascript" src="../../jqSuite/jqvisualform/js/jquery.js"></script>
<script type="text/javascript" src="../../jqSuite/jqvisualform/js/jquery-ui-custom.min.js"></script>
<script type="text/javascript" src="../../jqSuite/jqvisualform/js/jquery.layout.js"></script>
<script type="text/javascript" src="../../jqSuite/jqvisualform/js/grid.locale-en.js"></script>
<script type="text/javascript" src="../../jqSuite/jqvisualform/js/jquery.jqGrid.min.js"></script>
<script type="text/javascript" src="../../jqSuite/jqvisualform/js/jquery.jqForm.js"></script>
<script type="text/javascript" src="../../jqSuite/jqvisualform/js/jqueryFileTree.js"></script>
<script type="text/javascript" src="../../jqSuite/jqvisualform/js/jquery.form.js"></script>
<script type="text/javascript" src="../../jqSuite/jqvisualform/js/codemirror/lib/codemirror.js"></script>
<script type="text/javascript" src="../../jqSuite/jqvisualform/js/codemirror/mode/xml/xml.js"></script>
<script type="text/javascript" src="../../jqSuite/jqvisualform/js/codemirror/mode/javascript/javascript.js"></script>
<script type="text/javascript" src="../../jqSuite/jqvisualform/js/codemirror/mode/css/css.js"></script>
<script type="text/javascript" src="../../jqSuite/jqvisualform/js/codemirror/mode/clike/clike.js"></script>
<script type="text/javascript" src="../../jqSuite/jqvisualform/js/codemirror/mode/php/php.js"></script>
<script type="text/javascript" src="../../jqSuite/jqvisualform/js/modernizr.js"></script>
