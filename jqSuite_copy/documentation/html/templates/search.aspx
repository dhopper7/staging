...
<HTML>
	<HEAD>
		...
		<LINK rel="stylesheet" type="text/css" href="../../../../jqSuite/documentation/html/templates/templates/wwhelp.css">
		<style> 
		INPUT { FONT-SIZE: 8pt } 
		</style>
	</HEAD>
		...
		<table class="tocbody" width="800">
			<tr>
				<td class="banner" HEIGHT="25" VALIGN="middle">&nbsp;<b style="font-size:10pt"><%= this.PageTitle %></b>
					<div style="font-size:8pt;margin-top:5pt;margin-bottom:3pt">&nbsp;<a href="../../../../jqSuite/documentation/html/templates/index2.htm" target="wwhelp_left">Contents</a> | <a href="../../../../jqSuite/documentation/html/templates/Keywords.htm" target="wwhelp_left">Keywords</a></div>
				</td>
			</tr>
		</table>
