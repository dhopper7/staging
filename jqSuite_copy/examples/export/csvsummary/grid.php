...
$grid->setGridOptions(array(
    ...
    "sortname"=>"OrderID",
	"caption"=>"CSV export with summary field"
));
...
// Enable excel csv
$grid->setNavOptions('navigator', array("csv"=>true, "add"=>false,"edit"=>false,"del"=>false,"view"=>false, "excel"=>false));
// Set summary field and passit to the grid renderer
