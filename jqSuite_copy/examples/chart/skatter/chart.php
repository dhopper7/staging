...
->setTitle(array('text'=>'Height Versus Weight of 507 Individuals by Gender'))
->setSubtitle(array("text"=>"Source: Heinz  2003"))
->setxAxis(array(
	"title"=>array(
		"enabled"=> true,
		"text"=> "Height (cm)"
...
->setyAxis(array(
	"title"=>array("text"=>"Weight (kg)")
))
->setTooltip(array(
	"formatter" => "function(){ return this.x +' cm, '+ this.y +' kg';}"
))
->setLegend(array(
	"layout"=> 'vertical',
	"align"=> 'left',
